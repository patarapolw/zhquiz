...
import { IDictionaryType } from '~/assets/schema'
import { speak } from '~/assets/speak'
import { IDictionary } from '~/store/dictionary'
...
export default class HanziPage extends Vue {
  ...
  current = {
    ...
    sup: [] as string[],
    variants: [] as string[],
    vs: [] as Pick<IDictionary, 'entry' | 'alt' | 'reading' | 'english'>[],
    ss: [] as Pick<IDictionary, 'entry' | 'english'>[],
  }
